...
当前尚未完成微信开发者工具导入与人工包体分析、双真机完整人工闭环、原生登录/分享、`connectContainer` 弱网与恢复联调、冷启动恢复/离房入口、微信后台发布资料确认，以及 Prefab/Auto Atlas/平台纹理压缩等后续优化和小游戏载体上的 Cocos 视觉 QA。Web Desktop 或浏览器联调通过不能替代这些验收。
